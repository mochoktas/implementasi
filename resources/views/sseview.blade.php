...
<script>
    ...
    var sse = new EventSource("<?php echo action('CSSE@sse'); ?>");
      sse.onmessage = function(e) {
          console.log(e);
          var data_json = JSON.parse(e.data);
        //   console.log(data_json);
        //   console.log(data_json[0].musik);
          document.getElementById("antrians").innerHTML=data_json[0].nomor_antrian;
          document.getElementById("lokets").innerHTML=data_json[0].loket;
